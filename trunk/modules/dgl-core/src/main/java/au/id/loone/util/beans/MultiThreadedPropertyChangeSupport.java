 ...
 */
public class MultiThreadedPropertyChangeSupport
{

    @SuppressWarnings({"UnusedDeclaration"})
    private static final Logger LOG = Logger.getLogger(MultiThreadedPropertyChangeSupport.class);
    ...
    /**
     */
    public MultiThreadedPropertyChangeSupport(
    ...
    )
    {
        ...
        for (final PropertyChangeListener listener: listeners) {
            try {
                ...
                LOG.warn("deliver: exception while delivering property change event: " + TraceUtil.formatObj(e), e);
            }
        }
